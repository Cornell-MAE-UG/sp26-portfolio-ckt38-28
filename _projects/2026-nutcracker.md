...
#### Given
![table of average nut hardness values]({{ "/assets/images/nut-hardness.png" | relative_url }}){: .inline-image-r style="width: 400px"}
![table of average grip strength for men and women]({{ "/assets/images/grip-strength.png" | relative_url }}){: .inline-image-r style="width: 400px"}
